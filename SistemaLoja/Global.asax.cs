...
namespace SistemaLoja
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        private void AddPermissoesSuperUser(ApplicationDbContext db)
        {
            ...
            var user = userManager.FindByEmail("henriquerauber@yahoo.com.br");
            ...
            //if (!userManager.IsInRole(user.Id, "Comprar"))
            //{
            //    userManager.AddToRole(user.Id, "Comprar");
            //}
        ...
        private void CriarSuperUser(ApplicationDbContext db)
        {
            ...
            if(user == null)
            {
                ...
                {
                    UserName = "henriquerauber@yahoo.com.br",
                    Email = "henriquerauber@yahoo.com.br"
                };

                userManager.Create(user, "R@ub3r");
            }
        }
        ...
        private void CriarRoles(ApplicationDbContext db)
        {
            ...
            //if (!roleManager.RoleExists("Comprar"))
            //{
            //    roleManager.Create(new IdentityRole("Comprar"));
            //}

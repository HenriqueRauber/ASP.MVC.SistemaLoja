...
namespace SistemaLoja.Controllers
{
    public class ProdutoAPIController : Controller
    {
        ...
        // GET: ProdutoAPI/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ProdutoAPI/Create
